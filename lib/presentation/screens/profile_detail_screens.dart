      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoField('Nombre Completo', 'Camila Andrea Espinoza Alfaro'),
            _buildInfoField('RUT', '20.458.293-K'),
            _buildInfoField('Fecha de Nacimiento', '12 de Mayo, 2002'),
            _buildInfoField('Correo Electrónico', 'camila.espinoza@correo.cl'),
